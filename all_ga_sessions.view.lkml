view: all_ga_sessions {
  sql_table_name: `149006597.ga_sessions_*`
    ;;
...
view: all_ga_sessions_custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: all_ga_sessions_hits__publisher_infos {
...
view: all_ga_sessions_hits__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: all_ga_sessions_hits__app_info {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
...
view: all_ga_sessions_hits__content_group {
...
view: all_ga_sessions_hits__content_info {
...
view: all_ga_sessions_hits__custom_variables {
...
view: all_ga_sessions_hits__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: all_ga_sessions_hits__experiment {
...
view: all_ga_sessions_hits__e_commerce_action {
...
view: all_ga_sessions_hits__promotion_action_info {
...
view: all_ga_sessions_hits__source_property_info {
...
view: all_ga_sessions_hits__item {
...
view: all_ga_sessions_hits__product {
  dimension: custom_dimensions {
    hidden: yes
    sql: ${TABLE}.customDimensions ;;
  }
...
view: all_ga_sessions_hits__product__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: all_ga_sessions_hits__product__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: all_ga_sessions_hits__social {
...
view: all_ga_sessions_hits__event_info {
...
view: all_ga_sessions_hits__latency_tracking {
...
view: all_ga_sessions_hits__publisher {
  dimension: ads_clicked {
    type: number
    sql: ${TABLE}.adsClicked ;;
  }
...
view: all_ga_sessions_hits__page {
  dimension: hostname {
    type: string
    sql: ${TABLE}.hostname ;;
  }
...
view: all_ga_sessions_hits__transaction {
...
view: all_ga_sessions_hits__exception_info {
...
view: all_ga_sessions_hits__promotion {
...
view: all_ga_sessions_hits__refund {
...
view: all_ga_sessions_geo_network {
  dimension: city {
    type: string
    sql: ${TABLE}.city ;;
  }
...
view: all_ga_sessions_traffic_source {
...
view: all_ga_sessions_traffic_source__adwords_click_info {
...
view: all_ga_sessions_traffic_source__adwords_click_info__targeting_criteria {
