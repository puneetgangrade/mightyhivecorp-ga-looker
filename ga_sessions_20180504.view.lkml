view: ga_sessions_20180504 {
  sql_table_name: `149006597`.ga_sessions_20180504
    ;;
...
view: ga_sessions_20180504__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20180504__totals {
  dimension: bounces {
    type: number
    sql: ${TABLE}.bounces ;;
  }
...
view: ga_sessions_20180504__hits__publisher_infos {
...
view: ga_sessions_20180504__hits {
  dimension: app_info {
    hidden: yes
    sql: ${TABLE}.appInfo ;;
  }
...
view: ga_sessions_20180504__hits__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20180504__hits__app_info {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
...
view: ga_sessions_20180504__hits__content_group {
...
view: ga_sessions_20180504__hits__content_info {
...
view: ga_sessions_20180504__hits__custom_variables {
...
view: ga_sessions_20180504__hits__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20180504__hits__experiment {
...
view: ga_sessions_20180504__hits__e_commerce_action {
...
view: ga_sessions_20180504__hits__promotion_action_info {
...
view: ga_sessions_20180504__hits__source_property_info {
...
view: ga_sessions_20180504__hits__item {
...
view: ga_sessions_20180504__hits__product {
  dimension: custom_dimensions {
    hidden: yes
    sql: ${TABLE}.customDimensions ;;
  }
...
view: ga_sessions_20180504__hits__product__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20180504__hits__product__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20180504__hits__social {
...
view: ga_sessions_20180504__hits__event_info {
...
view: ga_sessions_20180504__hits__latency_tracking {
...
view: ga_sessions_20180504__hits__publisher {
  dimension: ads_clicked {
    type: number
    sql: ${TABLE}.adsClicked ;;
  }
...
view: ga_sessions_20180504__hits__page {
  dimension: hostname {
    type: string
    sql: ${TABLE}.hostname ;;
  }
...
view: ga_sessions_20180504__hits__transaction {
...
view: ga_sessions_20180504__hits__exception_info {
...
view: ga_sessions_20180504__hits__promotion {
...
view: ga_sessions_20180504__hits__refund {
...
view: ga_sessions_20180504__geo_network {
  dimension: city {
    type: string
    sql: ${TABLE}.city ;;
  }
...
view: ga_sessions_20180504__traffic_source {
...
view: ga_sessions_20180504__traffic_source__adwords_click_info {
...
view: ga_sessions_20180504__traffic_source__adwords_click_info__targeting_criteria {
...
view: ga_sessions_20180504__device {
  dimension: browser {
    type: string
    sql: ${TABLE}.browser ;;
  }
